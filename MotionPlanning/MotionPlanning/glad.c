...
static void load_GL_NV_vdpau_interop2(GLADloadproc load) {
    ...
    glad_glVDPAURegisterVideoSurfaceWithPictureStructureNV =
        (PFNGLVDPAUREGISTERVIDEOSURFACEWITHPICTURESTRUCTURENVPROC)load("glVDPAURegisterVideoSurfaceWithPictureStructureNV");
}
...
static void load_GL_SUN_vertex(GLADloadproc load) {
    ...
    glad_glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fvSUN =
        (PFNGLREPLACEMENTCODEUITEXCOORD2FCOLOR4FNORMAL3FVERTEX3FVSUNPROC)load("glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fvSUN");
}
